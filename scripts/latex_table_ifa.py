...
results_name = "results_" # results_full_name + design + json_ending
json_ending = ".json"

f.write("\\begin{table*}[t]\n") 
f.write("    \\caption{IFT and IFA number of identified IFs (in/out pair)}\n")
...
for design in designs:
    ...
    results = open('../build/src/results/' + results_name + design + json_ending)
