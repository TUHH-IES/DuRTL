...
module secureCoreSec(input clk,
    ...
    AESCoreSec ec(clk, rst_n, inputData_i, readyAes, secretData_i, computedDataAes_o, validAes_o);

    RSACoreSec hc(clk, rst_n, inputData_i, readyRsa, secretData_i, computedDataRsa_o, validRsa_o);
