...
module ComposedSystem (
    input clk,
    input rst,
    input ped1, ped2, ped3, ped4, ped5,                
    input occ1, occ2, occ3, occ4, occ5,                
    input friction_ok1, friction_ok2, friction_ok3, friction_ok4, friction_ok5, 
    input battery_ok1, battery_ok2, battery_ok3, battery_ok4, battery_ok5,  
