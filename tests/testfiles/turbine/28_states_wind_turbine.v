...
module WindTurbine (
    ...
    parameter NORMAL_OPERATION     = 8'b00000000,
          ...
          SAFETY_SYSTEMS_ENGAGE    = 8'b00001101,
          SYSTEM_BOOT              = 8'b00001110,
          HARDWARE_CHECK           = 8'b00001111,
          FIRMWARE_LOAD            = 8'b00010000,
          SELF_DIAGNOSTICS         = 8'b00010001,
          ENVIRONMENTAL_CHECK      = 8'b00010010,
          WIND_SPEED_EVALUATION    = 8'b00010011,
          GRID_PRE_SYNC_CHECK      = 8'b00010100,
          BRAKE_RELEASE            = 8'b00010101,
          BEARING_WARM_UP          = 8'b00010110,
          PITCH_CALIBRATION        = 8'b00010111,
          INERTIA_SYNC             = 8'b00011000,
          VOLTAGE_REGULATION       = 8'b00011001,
          FREQUENCY_MATCHING       = 8'b00011010,
          SHUTDOWN                 = 8'b00011011;
        ...
        case (turbine_state)
            ...
            CONTROL_LOGIC_INIT: begin
                if (env == REDUCED_SPEED || env == BLADE_ADJUSTMENT || park_command == NORMAL_OPERATION || park_command == REDUCED_SPEED)
                    ...
                    turbine_state <= SAFETY_SYSTEMS_ENGAGE;
            end
            SAFETY_SYSTEMS_ENGAGE: begin
                if (env == REDUCED_SPEED || env == BLADE_ADJUSTMENT || park_command == NORMAL_OPERATION || park_command == REDUCED_SPEED)
                    turbine_state <= CONTROL_LOGIC_INIT;
                else if ((env == SHUTDOWN || park_command == SHUTDOWN))
